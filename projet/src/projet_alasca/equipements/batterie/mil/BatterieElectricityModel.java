package projet_alasca.equipements.batterie.mil;
...
import projet_alasca.equipements.batterie.BatterieI;
...
type = Double.class)
@ModelImportedVariable(name = "currentPanneauSolaireIntensity",
type = Double.class)
@ModelExportedVariable(name = "currentStockEnergy",
type = Double.class)


public class BatterieElectricityModel 
extends AtomicHIOA {
	...
	// -------------------------------------------------------------------------
		...
		public static final String		URI = BatterieElectricityModel.class.
																	getSimpleName();
		...
		@ImportedVariable(type = Double.class)
		protected Value<Double>			currentPanneauSolaireIntensity;
		...
		/** current energy storage in the Batterie 								*/
		 ...
		 */
		public				BatterieElectricityModel(
			String uri,
			TimeUnit simulatedTimeUnit,
			SimulatorI simulationEngine
			) throws Exception
		{
			super(uri, simulatedTimeUnit, (AtomicSimulatorI) simulationEngine);
		...
		throws Exception
		{
			...
			if (!this.currentIntensity.isInitialised() &&
								...
								this.currentPanneauSolaireIntensity.isInitialised()) {
		...
		*/
			...
			)
		{
			...
			if (simParams.containsKey(
							BatterieRTAtomicSimulatorPlugin.OWNER_RPNAME)) {
